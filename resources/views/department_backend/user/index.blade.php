                    ...
                    <div class="panel-heading">
                        <div class="panel-heading">
                            <ol class="breadcrumb col-md-6">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('department.users','list')}}">Users List</a></li>
                            </ol>
                             <form method="get" action="{{route('department.users','list')}}" class="form-inline d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
...
<!--                                            <a href="{{route('user.edit',$user['id'])}}" title="Edit User"><i class="fa fa-edit fa-fw"></i></a>-->
                                            <a href="{{route('department.users',['param'=>'view','id'=>$user['id']])}}" title="View Details"><i class="fa fa-eye fa-fw"></i></a>
