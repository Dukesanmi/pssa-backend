...
<script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data.result, function( index, value ) {
                        var extension = value.type.split('.').pop();
                ...
                $.each(data.result, function( index, value ) {
                    if(value.user_type==0){ // if sender
                        if(value.type=='image'){ // if image is sended by other side
                            appendhtml="<li class='left-li li-message-chat-common'>" +
                                "<div class='row'></div><div class='col-md-12'></div><div class='message_right_content col-md-12 col-sm-12 col-xs-12'>" +
                                "<div class='msg_box'><h6></h6> <p><b>User</b></p> <img src="+value.image+" height='100px' width='100px'><small>"+value.created_at+"</small>" +
                                "</div></div></li>";
                        }
                        else{ //if text is sended by other end
                            appendhtml="<li class='left-li li-message-chat-common'>" +
                                "<div class='row'></div><div class='col-md-12'></div><div class='message_right_content col-md-12 col-sm-12 col-xs-12'>" +
                                "<div class='msg_box'><h6></h6> <p><b>User</b></p> <small> "+value.message+"</small><small>"+value.created_at+"</small>"+
                                "</div></div></li>";
                        }
                    }else{ // if receiver
                        if(value.type=='image'){ // if image is sended by other side
                            appendhtml="<li class='left-li li-message-chat-common'>" +
                                "<div class='row'></div><div class='col-md-12'></div><div class='message_left_content col-md-12 col-sm-12 col-xs-12'>" +
                                "<div class='msg_box'><h6></h6> <p><b>Officer</b></p> <a target='_blank' href="+value.image+"><img src="+value.image+" height='280px' width='280px'></a><small>"+value.created_at+"</small></div></div></li>";
                        }else if(value.type=='video'){
                            appendhtml="<li class='left-li li-message-chat-common'>" +
                                "<div class='row'></div><div class='col-md-12'></div><div class='message_left_content col-md-12 col-sm-12 col-xs-12'>" +
                                "<div class='msg_box'><h6></h6> <p><b>Officer</b></p> <video src='"+value.image+"'width='280' height='280' controls></video><small>"+value.created_at+"</small></div></div></li>";
                        }
                        else{ //if text is sended by other end
                            appendhtml="<li class='left-li li-message-chat-common'>" +
                                "<div class='row'></div><div class='col-md-12'></div><div class='message_left_content col-md-12 col-sm-12 col-xs-12'>" +
                                "<div class='msg_box'><h6></h6> <p><b>Officer</b></p> <small>"+value.message+"</small><small>"+value.created_at+"</small></div></div></li>";
                        }
                    }
                    $("ul.do-chat-list").append(appendhtml);
                    $(".seechat").animate({ scrollTop: $("#seechat").height() }, 0);
                });
    ...
    $("#chting_btn2").click(function () {
        ...
        $.ajax({
            ...
            data:{'user_2_id':769,'country_code':'NG','department_id':$("#department_id").val()},
            success: function(data) {
                $('#upload-image').hide(); //hiding image  on the success of sending image
                var userId='<?php echo $userid ?>';
                var appendhtml='';
                ...
                $.each(data.result, function( index, value ) {
                    ...
                    $("ul.do-chat-list").append(appendhtml);
                    $(".scrllD").animate({ scrollTop: $("#list-down-D").height() }, 0);
                });
                @else  //superadmin
                $.each(data.result, function( index, value ) {
                    if(value.user_type==3){ // if sender
...
// alert("hello");
    ...
    $('#chting_btn2').click(function(){
        set3=setInterval(checkNewChatMessage2, 5000);
    ...
    $("#message2").keypress(function (event) {
        ...
        if(keycode == '13'){
            ...
            $('#message2').removeAttr('value');
        }
    });
    // ddddddddddddddddddddddd
    $("#conv_btn").click(function () {
        set=setInterval(checkNewConvoMessage, 1000);
 ...
 // $("ul.do-chat-list").empty();
                    ...
                    $.each(data.result, function( index, value ) {
                        ...
                        if(value.user_type==1)
                        {
                            if(value.type=='image'){ // if message is image
                                appendhtml="<li class='left-li li-message-chat-common'>" +
                                    "<div class='row'></div><div class='col-md-12'></div><div class='message_left_content col-md-12 col-sm-12 col-xs-12'>" +
                                    "<div class='msg_box'><h6></h6> <p><b>Officer</b></p><a href="+value.image+"><img src="+value.image+" height='280' width='280'></a><small>"+value.created_at+"</small></div></div></li>";
                            }else if(value.type=='video'){
                                appendhtml="<li class='left-li li-message-chat-common'>" +
                                    "<div class='row'></div><div class='col-md-12'></div><div class='message_left_content col-md-12 col-sm-12 col-xs-12'>" +
                                    "<div class='msg_box'><h6></h6><p><b>Officer</b></p><video width='280' height='280' controls src="+value.image+"></video><small>"+value.created_at+"</small></div></div></li>";
                            }
                            else{ //if message is text
                                appendhtml="<li class='left-li li-message-chat-common'>" +
                                    "<div class='row'></div><div class='col-md-12'></div><div class='message_left_content col-md-12 col-sm-12 col-xs-12'>" +
                            ...
                            if(value.type=='image'){ // if message is image
                                appendhtml="<li class='left-li li-message-chat-common'>" +
                                    "<div class='row'></div><div class='col-md-12'></div><div class='message_right_content col-md-12 col-sm-12 col-xs-12'>" +
                                    "<div class='msg_box'><h6></h6> <p><b>User</b></p><a href="+value.image+"><img src="+value.image+" height='280' width='280'></a><small>"+value.created_at+"</small></div></div></li>";
                            }else if(value.type=='video'){
                                appendhtml="<li class='left-li li-message-chat-common'>" +
                                    "<div class='row'></div><div class='col-md-12'></div><div class='message_right_content col-md-12 col-sm-12 col-xs-12'>" +
                                    "<div class='msg_box'><h6></h6> <p><b>User</b></p><video width='280' height='280' controls src="+value.image+"></video><small>"+value.created_at+"</small></div></div></li>";
                            }
                            else{ //if message is text
                                appendhtml="<li class='left-li li-message-chat-common'>" +
                                    "<div class='row'></div><div class='col-md-12'></div><div class='message_right_content col-md-12 col-sm-12 col-xs-12'>" +
                                    "<div class='msg_box'><h6></h6> <p><b>User</b></p><small>"+value.message+"</small><small>"+value.created_at+"</small></div></div></li>";
                            }
                        }
                        // $("ul.do-chat-list").empty();
                        $("ul.do-chat-list").append(appendhtml);
    ...
    // send message on eneter to department



    // send message with enter ends here
