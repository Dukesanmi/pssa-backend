        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li><p><b>Medical Department</b></p>
                        <form id="logout-form"  action="{{ route('fire.logout') }}" method="POST">
                            {{ csrf_field() }}
                            <a href="{{ route('fire.logout') }}"><i class="fa fa-sign-out fa-fw"></i>Logout</a>
                        </form>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    {{--</li>--}}
                    <li>
                        <a href="{{route('fire.home')}}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="{{route('fire.users','list')}}"><i class="fa fa-users fa-fw"></i> Users</a>
                    </li>
<!--                    <li>-->
...
<!--                    </li>-->
<!--                      <li>-->
<!--                        <a href="{{route('department.index')}}"><i class="fa fa fa-building-o fa-fw"></i>Officer Department</a>-->
<!--                    </li>-->
                    <!-- <li>
                        <a href="{{route('fire.department.users','list')}}"><i class="fa fa fa-building-o fa-fw"></i>Medical Department</a>
                    </li> -->
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
