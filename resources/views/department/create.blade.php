...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Create Police Department</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('department.index')}}">Police Department List</a></li>
                            <li class="breadcrumb-item active">Create Police Department</li>
                        </ol>
                    </div>
                    @if ($errors->any())
                                          ...
                                          <div class="form-group">
                                            <div class="form-row col-md-12">
                                                ...
                                                <div class="col-md-6 {{ $errors->has('image') ? ' has-error' : '' }}">
                                                    ...
                                                    <input type="file" name="image" placeholder="Enter " aria-describedby="nameHelp" class="form-control my_file" accept="image/x-png,image/gif,image/jpeg" /autofocus autofocus>
                                                       @if ($errors->has('image'))
                                                        <span class="help-block">
