...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Police Department Detail</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                    ...
                    <div class="panel-heading">
                        <div class="panel-heading">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('officer.index')}}">Police Department List</a></li>
                                <li class="breadcrumb-item active">View Police Department Detail</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.panel-heading -->
