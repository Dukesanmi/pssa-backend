...
<tr>
<td align="center" valign="top" style="font-size: 25px; color: #ff0000; font-family: Montserrat, sans-serif; ">!!! CRIME REPORT ALARM !!!</td>
</tr>
...
<td align="center" valign="top" style="font-family: Montserrat, sans-serif;">Info on my helper network:</td>
  ...
  <tr>
    <td style="width: 50%; font-size: 18px; font-weight: 600; font-family: Montserrat, sans-serif;">Nature of crime:</td>
    <td style="width: 50%; font-size: 18px; font-weight: bold; font-family: Montserrat, sans-serif;">{{$inputs['nature_of_crime']}}</td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="width: 50%; font-size: 18px; font-weight: 600; font-family: Montserrat, sans-serif;">Neighbour Address</td>
    <td style="width: 50%; font-size: 18px; font-weight: bold; font-family: Montserrat, sans-serif;">{{$inputs['neighbour_address']}}</td>
  </tr>
  <tr>
