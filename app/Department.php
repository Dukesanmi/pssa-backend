...
public function  getDepartmentList($searchKey) {
      ...
      return  $this
            ->select(
               'id','name','surname','profile_pic','mobile_number','email','password','state','city','address','status','created_at','updated_at')
 ...
 public function findStateDepartment($inputs){
        ...
        return  $this
            ->select(
               'id', 'name', 'surname','profile_pic','mobile_number', 'email','password',  'state','city','address')
