    ...
    public  function index(Request $request){
        try {
            if ($request->isMethod('get')) {
                ...
                $getCrime = (new Crime())->getCrimeList()
                ...
                return view('crime.index',compact('getCrime','searchKey'));
            }
    ...
    public function show(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->isMethod('get')) {
                ...
                $crimeReport = (new Crime())->getCrimeDetail($id)->first();
             
                $emergencyDepartmentInfo = (new Department())->where('id',$crimeReport['department_id'])->first();

               	$getCrimeReportFiles = DB::table('report_crime_files')->where('report_crime_id', $crimeReport['rc_id'])->get();
                   

                return view('crime.view',compact('crimeReport','emergencyDepartmentInfo','getCrimeReportFiles'));
            }
