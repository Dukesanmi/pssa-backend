...
class AmbulanceRequestController extends Controller
{
    ...
    public  function index(Request $request){
        try {
            if ($request->isMethod('get')) {
                ...
                $getAmbulanceList = (new Ambulance())->getAmbulanceList()
                ...
                return view('ambulance.index',compact('getAmbulanceList','searchKey'));
            }
    ...
    public function show(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->isMethod('get')) {
                $ambulanceRequest = (new Ambulance())->getAmbulanceDetail($id)->first();
               
                return view('ambulance.view',compact('ambulanceRequest'));
            }
